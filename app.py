...
# ==========================================
# 1. SAHIFA SOZLAMALARI (Markazlashgan va O'qishli rejim)
# ==========================================
st.set_page_config(page_title="909 RA | Recruitment Portal", page_icon="🚛", layout="centered")

# Moslashuvchan tugma dizayni (Oq/Qora rejimga xalaqit bermaydi)
st.markdown("""
<style>
...
st.markdown("💡 *Theme Mode:* Yuqori o'ng burchakdagi ( ⋮ ) menyusiga kirib, **Settings ➔ Theme** orqali Oq yoki Qora (Dark/Light) rejimni tanlashingiz mumkin.")
st.markdown("---")
